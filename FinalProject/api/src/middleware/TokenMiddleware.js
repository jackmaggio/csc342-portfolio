...
const TOKEN_COOKIE_NAME = "QuizMeToken";
// The secret is located in your local .env file (create if it does not exist, git doesn't and shouldn't track it)
...
exports.generateToken = (req, res, user) => {
  ...
  // API_SECRET = "60d0954e20eaa0c02b382171c33c53bc18522cc6d4805eaa02e182b0";
  ...
  res.cookie(TOKEN_COOKIE_NAME, token, {
    httpOnly: true,
    secure: true,
    maxAge: 20 * 60 * 1000, //This session expires in 20 minutes.. but token expires in 1 hour!
  });
};
